      ...
      body: Container(
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              KInputField("Name".tr, "Name".tr, Icons.account_circle,
                  addRecordController.name, TextInputType.text, context),
              KInputField("Number".tr, "Number".tr, Icons.account_circle,
                  addRecordController.number, TextInputType.phone, context),
              KInputField("Address".tr, "Address".tr, Icons.account_circle,
                  addRecordController.address, TextInputType.text, context),
              KInputField("Length".tr, "Length".tr, Icons.account_circle,
                  addRecordController.length, TextInputType.number, context),
              KInputField("Arm".tr, "Arm".tr, Icons.account_circle,
                  addRecordController.arm, TextInputType.number, context),
              KInputField("Teera".tr, "Teera".tr, Icons.account_circle,
                  addRecordController.teera, TextInputType.number, context),
              KInputField("boundary".tr, "boundary".tr, Icons.account_circle,
              ...
              KInputField(
                  ...
                  context),
              KInputField("paincha".tr, "paincha".tr, Icons.account_circle,
                  addRecordController.paincha, TextInputType.number, context),
              KInputField("Collar tip".tr, "Collar tip".tr, Icons.account_circle,
                  addRecordController.collerTip, TextInputType.number, context),
              KInputField("Cuff".tr, "Cuff".tr, Icons.account_circle,
